    ...
    <div className="auth-container-premium">
      ...
      >
        <div className="auth-header">
          ...
          <h1 className="premium-gradient-text">Create Account</h1>
          <p>Join SmartRush and experience lightning fast delivery.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="premium-form">
          ...
          <div className="form-group-premium">
            ...
            <div className="role-selector-premium">
              ...
              <button 
                type="button" 
                className={`role-btn ${formData.role === 'store_owner' ? 'active' : ''}`}
      ...
      <style>{`
        ...
        .auth-header .logo-box { margin: 0 auto 20px; width: 40px; height: 40px; font-size: 18px; }
        .auth-header h1 { font-size: 28px; font-weight: 800; margin-bottom: 6px; }
        .auth-header p { color: var(--text-muted); font-size: 14px; }

        .form-group-premium { text-align: left; margin-bottom: 20px; }
        .form-group-premium label { display: block; font-size: 12px; font-weight: 700; color: var(--text-muted); margin-bottom: 8px; margin-left: 4px; }
        ...
        .auth-btn { width: 100%; margin-top: 12px; padding: 14px; }
        
        .auth-footer { margin-top: 24px; color: var(--text-muted); font-size: 13px; }
